...
imgcreateThread1 = imgcreateThread(1, "Thread-imgcreate", 1)
modeltrainThread2 = modeltrainThread(2, "Thread-modeltrain", 2)
# 开启新线程
imgcreateThread1.start()
modeltrainThread2.start()

imgcreateThread1.join()
modeltrainThread2.join()
print ("退出主线程")